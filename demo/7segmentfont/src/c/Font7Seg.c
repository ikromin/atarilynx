...
static SCB_RENONE* sprite = &(seg7FontSprite[0]);

static u8 spr1PxData[] = {0x0};
static SCB_REHV_PAL spr1Px = {
	BPP_1 | TYPE_NORMAL, REHV | LITERAL, 0x0, 0x0, &spr1PxData[0], -100, -100, 0x100, 0x100,
	{ 0x01, 0x23, 0x45, 0x67, 0x89, 0xab, 0xcd, 0xef }
};

void __fastcall__ set7SegColor(u8 color) {
  (&spr1Px)->penpal[5] = color;
  tgi_sprite(&spr1Px);
}
